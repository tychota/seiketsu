"""
Production settings for seiketsu project.
...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['seiketsu.cloud.bam.tech', ])
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='seiketsu <noreply@seiketsu.cloud.bam.tech>')
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[seiketsu]')
