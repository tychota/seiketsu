...
Seiketsu (Standardization): Establish methods within the company that will ensure the effective continuation of organization, orderliness and cleanliness
...
.. code-block:: bash
    ...
    cd seiketsu
    celery -A seiketsu.taskapp worker -l info
